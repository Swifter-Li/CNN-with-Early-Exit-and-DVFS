...
class ResNet_exits_eval(nn.Module):
    ...
    def normal_forward(self, x):
        ...
        temp2 = x
        x = F.relu(self.layer1_block1_bn1(self.layer1_block1_conv1(x)))
        self.count_store[3] += 64*32*64*32
        current_layer = 1
        if self.target_layer == 1:
            if self.quant_switch == 1:
                x_exit_1 =  self.block1_exit_0(self.dequant(x))
        ...
        if self.quant_switch == 1:
            x = self.quant(x)
        self.count_store[3] += 64*32*64*32*2
        current_layer = 2
        if self.target_layer == 2:
            if self.quant_switch == 1:
                x_exit_1 =  self.block1_exit_0(self.dequant(x))
        ...
        if self.quant_switch == 1:
            x = self.quant(x)
        self.count_store[3] += 32*32*64*64*2
        current_layer = 4
        if self.target_layer == 4:
            if self.quant_switch == 1:
                x_exit_1 =  self.block2_exit_0(self.dequant(x))
        ...
        temp2 = self.layer2_block1_bn3(self.layer2_block1_shortcut(x))
        x = F.relu(self.layer2_block1_bn1(self.layer2_block1_conv1(x)))
        self.count_store[3] += 32*32*128*128
        current_layer = 7
        if self.target_layer == 7:
            if self.quant_switch == 1:
                x_exit_1 =  self.block1_exit_1(self.dequant(x))
        ...
        if self.quant_switch == 1:
            x = self.quant(x)
        self.count_store[3] += 32*32*128*128+32*32*64*128
        current_layer = 8
        if self.target_layer == 8:
            if self.quant_switch == 1:
                x_exit_1 =  self.block1_exit_1(self.dequant(x))
        ...
        if self.quant_switch == 1:
            x = self.quant(x)
        self.count_store[3] += 32*32*128*128*2
        current_layer = 10
        if self.target_layer == 10:
            if self.quant_switch == 1:
                x_exit_1 =  self.block2_exit_1(self.dequant(x))
        ...
        temp2 = self.layer3_block1_bn3(self.layer3_block1_shortcut(x))
        x = F.relu(self.layer3_block1_bn1(self.layer3_block1_conv1(x)))
        self.count_store[3] += 32*32*256*128
        current_layer = 15
        if self.target_layer == 15:
            if self.quant_switch == 1:
                x_exit_1 =  self.block1_exit_2(self.dequant(x))
        ...
        if self.quant_switch == 1:
            x = self.quant(x)
        self.count_store[3] += 32*32*256*256 + 32*32*256*128
        current_layer = 16
        if self.target_layer == 16:
            if self.quant_switch == 1:
                x_exit_1 =  self.block1_exit_2(self.dequant(x))
        ...
        temp2 = x
        x = F.relu(self.layer3_block2_bn1(self.layer3_block2_conv1(x)))
        self.count_store[3] += 32*32*256*256
        current_layer = 17
        if self.target_layer == 17:
            if self.quant_switch == 1:
                x_exit_1 =  self.block2_exit_2(self.dequant(x))
        ...
        if self.quant_switch == 1:
            x = self.quant(x)
        self.count_store[3] += 32*32*256*256*2
        current_layer = 18
        if self.target_layer == 18:
            if self.quant_switch == 1:
                x_exit_1 =  self.block2_exit_2(self.dequant(x))
        ...
        temp2 = self.layer4_block1_bn3(self.layer4_block1_shortcut(x))
        x = F.relu(self.layer4_block1_bn1(self.layer4_block1_conv1(x)))
        self.count_store[3] += 32*32*512*256
        current_layer = 27
        if self.target_layer == 27:
            if self.quant_switch == 1:
                x_exit_1 =  self.block1_exit_3(self.dequant(x))
            ...
            x_exit_1 = self.layer4_exit_0_fc(x_exit_1)
            exit1 = self.layer4_exit_1_fc(x_exit_1)
            self.count_store[3] += 32*32*512*64 + 512 * (2*64-1) + 64 * 19
            ratio = self._calculate_max_activation( exit1 ) / (self.beta * self.activation_threshold_list[current_layer-1])
            time2 = time.perf_counter()
            layer_end = current_layer
            if count == 0:           
        ...
        if self.quant_switch == 1:
            x = self.quant(x)
        self.count_store[3] += 32*32*512*256 + 32*32*512*512
        current_layer = 28
        if self.target_layer == 28:
            if self.quant_switch == 1:
                x_exit_1 =  self.block1_exit_3(self.dequant(x))
        ...
        temp2 = x
        x = F.relu(self.layer4_block2_bn1(self.layer4_block2_conv1(x)))
        self.count_store[3] += 32*32*512*512
        current_layer = 29
        if self.target_layer == 29:
            if self.quant_switch == 1:
                x_exit_1 =  self.block2_exit_3(self.dequant(x))
        ...
        if self.quant_switch == 1:
            x = self.quant(x)
        self.count_store[3] += 32*32*512*512*2
        current_layer = 30
        if self.target_layer == 30:
            if self.quant_switch == 1:
                x_exit_1 =  self.block2_exit_3(self.dequant(x))
    ...
    def test_on_train_normal_forward(self, x):
        ...
        temp2 = self.layer2_block1_bn3(self.layer2_block1_shortcut(x))
        x = F.relu(self.layer2_block1_bn1(self.layer2_block1_conv1(x)))
        self.count_store[3] += 64*32*128*32
        current_layer = 7
        if current_layer in self.possible_layer:
            if self.quant_switch == 1:
                x_exit_1 =  self.block1_exit_1(self.dequant(x))
        ...
        if self.quant_switch == 1:
            x = self.quant(x)
        self.count_store[3] += 128*32*128*32 + 128*32*64*32
        current_layer = 8
        if current_layer in self.possible_layer:
            if self.quant_switch == 1:
                x_exit_1 =  self.block1_exit_1(self.dequant(x))
        ...
        if self.quant_switch == 1:
            x = self.quant(x)
        self.count_store[3] += 128*32*128*32*2
        current_layer = 10
        if current_layer in self.possible_layer:
            if self.quant_switch == 1:
                x_exit_1 =  self.block2_exit_1(self.dequant(x))
        ...
        temp2 = self.layer3_block1_bn3(self.layer3_block1_shortcut(x))
        x = F.relu(self.layer3_block1_bn1(self.layer3_block1_conv1(x)))
        self.count_store[3] += 128*32*256*32
        current_layer = 15
        if current_layer in self.possible_layer:
            if self.quant_switch == 1:
                x_exit_1 =  self.block1_exit_2(self.dequant(x))
        ...
        if self.quant_switch == 1:
            x = self.quant(x)
        self.count_store[3] += 256*32*256*32 + 128*32*256*32
        current_layer = 16
        if current_layer in self.possible_layer:
            if self.quant_switch == 1:
                x_exit_1 =  self.block1_exit_2(self.dequant(x))
        ...
        temp2 = x
        x = F.relu(self.layer3_block2_bn1(self.layer3_block2_conv1(x)))
        self.count_store[3] += 256*32*256*32
        current_layer = 17
        if current_layer in self.possible_layer:
            if self.quant_switch == 1:
                x_exit_1 =  self.block2_exit_2(self.dequant(x))
        ...
        if self.quant_switch == 1:
            x = self.quant(x)
        self.count_store[3] += 256*32*256*32*2
        current_layer = 18
        if current_layer in self.possible_layer:
            if self.quant_switch == 1:
                x_exit_1 =  self.block2_exit_2(self.dequant(x))
        ...
        temp2 = self.layer4_block1_bn3(self.layer4_block1_shortcut(x))
        x = F.relu(self.layer4_block1_bn1(self.layer4_block1_conv1(x)))
        self.count_store[3] += 256*32*512*32
        current_layer = 27
        if current_layer in self.possible_layer:
            if self.quant_switch == 1:
                x_exit_1 =  self.block1_exit_3(self.dequant(x))
        ...
        if self.quant_switch == 1:
            x = self.quant(x)
        self.count_store[3] += 256*32*512*32*2 + 512*32*512*32
        current_layer = 28
        if current_layer in self.possible_layer:
            if self.quant_switch == 1:
                x_exit_1 =  self.block1_exit_3(self.dequant(x))
        ...
        temp2 = x
        x = F.relu(self.layer4_block2_bn1(self.layer4_block2_conv1(x)))
        self.count_store[3] += 512*32*512*32
        current_layer = 29
        if current_layer in self.possible_layer:
            if self.quant_switch == 1:
                x_exit_1 =  self.block2_exit_3(self.dequant(x))
        ...
        if self.quant_switch == 1:
            x = self.quant(x)
        self.count_store[3] += 512*32*512*32*2
        current_layer = 30
        if current_layer in self.possible_layer:
            if self.quant_switch == 1:
                x_exit_1 =  self.block2_exit_3(self.dequant(x))
